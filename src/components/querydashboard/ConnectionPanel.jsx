...
const ConnectionPanel = ({
    ...
    const [showJwt, setShowJwt] = React.useState(false);
                    ...
                    <div className="flex gap-4">
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                name="authMode"
                                checked={jwtMode}
                                onChange={() => setJwtMode(true)}
                                className="w-4 h-4 text-blue-600"
                            />
                            <span className="text-gray-700">JWT Token</span>
                        </label>
                    </div>
                </div>

                <form className="space-y-4" onSubmit={handleSubmit(jwtMode ? onSubmitJwt : onSubmit)}>
                    {/* Server URL */}
                    <div>
                    ...
                    {/* JWT Token Input - Only shown in JWT mode */}
                    {jwtMode && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                JWT Token
                    ...
                    {/* Username - Only shown in username/password mode */}
                    {!jwtMode && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                Username
                    ...
                    {/* Password - Only shown in username/password mode */}
                    {!jwtMode && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                Password
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full border border-gray-400 rounded-lg py-1 px-2 pr-8"
                                />
                                <button
                                    type="button"
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            {isSubmitting ? "Connecting..." : jwtMode ? "Connect with JWT" : "Connect"}
                        </button>
